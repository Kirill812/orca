...
//
// The light/high-contrast theme names the colour of content on a filled button `colors.onFill`
// instead of borrowing `colors.bgBase` (same value in the dark and light palettes; black in high
// contrast, where buttons lose their fill). The tasks drawers carry that swap in style values and
// icon `color` props, so the style and render-tree hashes move and nothing else does.
...
const PRE_REFACTOR_STYLES = 'c7e1b31e2716bdfe6146fde67e48b156ef92b240cf8ef41d77f0d05db3ece36d'
const SCREEN_RPC_RENDER_TREE = 'aeb0f1700f1c2bdad8cd9e2911be04d922df99b3ecb0fd5a4de3976c17cc5aa0'
